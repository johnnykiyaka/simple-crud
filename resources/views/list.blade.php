...
<a href="javascript:void(0)" class="btn btn-info ml-3" id="create-new-client">Add New</a>
<br><br>
...
<script>
    ...
    $.get('ajax-crud-list/' + client_id +'/edit', function (data) {
    $('#name-error').hide();
    $('#email-error').hide();
    ...
    $.ajax({
    type: "get",
    url: SITEURL + "ajax-crud-list/delete/"+client_id,
